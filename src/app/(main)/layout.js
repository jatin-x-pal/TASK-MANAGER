...
export default function MainLayout({ children }) {
  ...
  const [notifications] = useState([
    { id: 1, text: 'Task "Design Logo" completed by Alex', time: '2m ago', type: 'success' },
    { id: 2, text: 'New project assigned to you', time: '1h ago', type: 'info' },
    { id: 3, text: 'Deadline approaching for "Draft Contract"', time: '3h ago', type: 'warning' },
  ]);
